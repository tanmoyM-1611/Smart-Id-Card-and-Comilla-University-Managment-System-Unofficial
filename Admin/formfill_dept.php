        ...
        <div class="main">
            <nav style="background-color: #e3f2fd" class="navbar navbar-expand-lg navbar-light ">
                <div class="container-fluid">
                    <a class="navbar-brand" href="homeAdmin.php">Department Office,Comilla University</a>
                            ...
                            <table class="table table-bordered" id="table_data" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $students["dept_bank"];?></td>
                                        ...
                                        <td>
                                              ...
                                              <?php
                                               ...
                                               if(($students["couDept_status"])==0)  { 
                                          echo  "<a id='ver' class='btn btn-warning m mt-1 mb-1'
                                                href='verifiedDeptformfill.php?status=1&&id=$students[formfill_id]'>VERIFIED</a>";
                                        
                                    
                                    }
                                    else{ echo "<a id='ver' class='btn btn-danger m mt-1 mb-1'
                                        href='verifiedDeptformfill.php?status=0&&id=$students[formfill_id]'>Not Verified</a>";}
