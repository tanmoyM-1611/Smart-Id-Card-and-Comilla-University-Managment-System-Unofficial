<?php
   ...
   $stdFormData= $projectAdmin->display_formfillinfoByHall_SHH();
        ...
        <div class="main">
            <nav style="background-color: #e3f2fd" class="navbar navbar-expand-lg navbar-light ">
                <div class="container-fluid">
                    <a class="navbar-brand" href="#">Sheikh Hasina Hall,Comilla University</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          ...
                                          echo  "<a id='ver' class='btn btn-warning m mt-1 mb-1'
                                                href='verifiedHall2.php?status=1&&id=$students[formfill_id]'>VERIFIED</a>";
                                        
                                    
                                    }
                                    else{ echo "<a id='ver' class='btn btn-danger m mt-1 mb-1'
                                        href='verifiedHall2.php?status=0&&id=$students[formfill_id]'>Not Verified</a>";}
