...
<div class="row row-cols-1 row-cols-md-3 g-4 student mt-1">
  ...
  <div class=" col-md-3 col-lg-6">
    <div class="card" style="width: 300px;">
      <img src="../User//assets//images//tanmoy.jpg" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">Tanmoy Mondal</h5>
        <p class="card-text">Id:11808044 <br> Session:2017-18</p>
      </div>
    </div>
  </div>
  <div class=" col-md-3 col-lg-6">
    <div class="card" style="width: 300px;">
      <img src="../User//assets//images//rana.jpg" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">Sohel Rana Hridoy</h5>
        <p class="card-text">Id:11808007 <br> Session:2017-18 </p>
      </div>
    </div>
  </div>
