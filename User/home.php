...
<div class="me-2 icon hidden-xs">
  ...
  <div class="col-md-6">
    ...
    <input type="text" class="form-control" name="stdHallName" id="inputHallName4">
  </div>
  <!-- name -->
  <div class="col-12">
...
<div class="col-md-6">
    ...
    <input type="text" name="stdFatherName" class="form-control" id="inputFathersName">
  </div>
  ...
  <div class="col-md-6">
    ...
    <input type="text" name="stdSession" class="form-control" id="inputSession" placeholder="2017-18">
  </div>
  <!-- img -->
  <div class="col-md-4" >
...
<br>
  ...
  <!-- Mobile -->
  <div class="col-md-6">
    <label for="inputNumber" class="form-label">Registration Number</label>
...
<!-- address1 -->
  <div class="col-12">
    ...
    <input type="text" name="stdPresentAddress" class="form-control" id="inputAddress" placeholder="Manikganj">
  </div>
  <!-- address2 -->
  <div class="col-12">
    <label for="inputParmanentAddress" class="form-label">Parmanent Address </label>
    <input type="text" name="stdParmanentAddress" class="form-control" id="inputAddress2" placeholder="Feni">
  </div>
